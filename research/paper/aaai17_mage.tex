...
\begin{document}
    ...
    \section{Abstract}
        ...
        The most popular method to create an artificial context 
        from a graph is collecting vertices in a random walk. However, recent research
        in skipgram-based graph embedding hinted the effectiveness of graph sampling
        manipulation. 
