...
\begin{document}
    ...
    \section{Methods and Experiments}
        ...
        \subsection{Experiments design}
            ...
            \begin{table}
                ...
                \resizebox{\columnwidth}{!}{%
                    \begin{tabular}{c r r r r}
                        \textsc{Dataset} & \textsc{\#Classes} & \textsc{\#Vertices} & \textsc{\#Edges} & \textsc{Task} \\
                        \hline \\
                        \textsc{Blogcatalog} & 39 & 10,312 & 333,983 & MC \\
                        \textsc{Wikipedia} & 40 & 4,777 & 184,812 & MC \\
                        \textsc{Citeseer} & 6 & 3,327 & 4,732 & MC \\
                        \textsc{Facebook} & - & 4,039 & 88,234 & LP \\
                        \end{tabular}%
                }
                \label{tb:data}
            ...
            walk for this graph. On the other hand, Wikipedia \cite{wiki} nad Citeseer \cite{citeseer} 
