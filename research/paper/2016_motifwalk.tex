...
Graph embedding is a dimension reduction technique
that represents vertices in a graph as a real vector
of lower dimensionality compare to the adjacency matrix
representation. In general, there are two approaches
to this problem. Traditionally, embedding task
involves matrix factorization. The most popular
technique is Spectral Clustering \cite{net}.
