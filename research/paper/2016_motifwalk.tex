...
information? Recent advancements in graph embedding has used
word embeddings techniques and deep architectures to propose a
feasible answer to this question. However, most of these work
only consider the notion of ``neighborhood'' by adjacency list.
In this paper, we propose a novel graph embedding algorithm that
consider graph motif structures into the latent vectors learning
process. By contrasting between sets of nodes created by normal
random walk and sets of nodes created by biased \emph{motif walk},
we showed that our algorithm's embedding results improves accuracy
in various benchmark graph mining task compare to existing algorithms.
