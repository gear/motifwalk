...
\begin{abstract}
  ...
  and semi-supervised graph embedding task. Our first model applies the most statistically
  ...
  the network structure information into a neural network.
  Both of our models utilize the higher-order organization 
  (i.e. motifs organization) of complex networks. We demonstrate the effectiveness of our 
  in comparison with state of the art network embedding and node labeling
  algorithms.
\end{abstract}
