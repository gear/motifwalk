...
motif $\mathcal{m}$ on an unweighted, directed graph $G$ is given by:
$$M_{i,j} = \sum_{(v, \chi_{\mathcal{A}}), v \in \mathcal{V}_G}$$

Present laplacian and power of laplacian of graph.  Present motif 
...
\subsection{Biased random walk - motifwalk}
